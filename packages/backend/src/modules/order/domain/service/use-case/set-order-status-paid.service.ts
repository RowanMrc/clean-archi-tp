...
export class SetOrderAsPaidService{
...
/*export class SetOrderAsPaidService {
  ...
  async setOrderStatusPaid(orderId : string): Promise<Order[]> {
    const orderPaid = await this.orderRepository.setOrderAsPaid(orderId);
    return orderPaid;
  }
}*/